...
public class ConstructorUtils {
     ...
     */
    @SuppressWarnings({"value:argument.type.incompatible", "value:assignment.type.incompatible", "index:argument.type.incompatible"}) // #1 isVarArgs => args has at least one element
